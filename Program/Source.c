...
void reset(char grade, int level, float experimence)
{
	printf("Grade : %c\n", grade);
	printf("Level : %d\n", level);
	printf("Experimence : %f\n", experimence);
}

void swap(argumentX, argumentY)
{
